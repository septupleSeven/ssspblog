...
const SiteConfig = () => {
  ...
  return (
    <div className="fixed left-0 top-0 z-[9999] flex h-[100%] w-[100%] items-center justify-center bg-black/60 semi-desktop:px-[20px]">
      <div className="relative z-[2] w-[100%] max-w-[500px] rounded-md bg-primary px-[30px] py-[40px] text-white dark:bg-primary-black dark:text-primary-white semi-mobile:px-[20px] semi-mobile:py-[30px]">
        <h1 className="mb-[40px] font-bold text-[1.75rem] semi-mobile:text-[1.375rem] semi-mobile:mb-[30px]">사이트 설정</h1>
